...
1. Sã se creeze tabelele EMP_***, DEPT_*** (în ºirul de caractere “***”, p reprezintã 
...
select * from emp_nem; --107 rez
select * from DEPT_***; --27 dept
commit;
...
ALTER TABLE emp_***
ADD CONSTRAINT fk_emp_DEPT_*** FOREIGN KEY(department_id)   --dept_id din emp_omg2
...
select * from dept_na  where department_id =300;
commit;
...
CREATE TABLE emp1_*** AS SELECT * FROM employees WHERE 1=0;
