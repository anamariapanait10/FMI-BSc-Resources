...
acestuia ºi numãrul de angajaþi. Se cer 2 solu?ii
...
Scrieþi ºi aceastã variantã de rezolvare.
select l.location_id, l.city
from locations l
...
WHERE EXISTS (SELECT 1    
              ...
              AND salary = (SELECT MAX(salary) --salariul maxim din departamentul 30
                            FROM    employees
...
11-2. Sã se afiºeze codul, prenumele ºi numele (pe aceeaºi coloanã), codul job-ului ºi data angajãrii,
...
13-2-2: top 14 valori medii ale salariilor  (problema de dinainte)
