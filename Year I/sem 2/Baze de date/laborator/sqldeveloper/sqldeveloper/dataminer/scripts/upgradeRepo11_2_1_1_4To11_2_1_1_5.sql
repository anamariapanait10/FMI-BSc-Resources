...
EXECUTE dbms_output.put_line('Start repository upgrade from 11.2.1.1.4 to 11.2.1.1.5. ' || systimestamp);
...
EXECUTE dbms_output.put_line('End repository upgrade from 11.2.1.1.4 to 11.2.1.1.5. ' || systimestamp);
